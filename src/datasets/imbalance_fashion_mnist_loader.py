...
class ImbalanceFASHIONMNISTDataLoader(DataLoader):
    """
    ...
    def __init__(self, data_dir, batch_size, shuffle=True, num_workers=1, training=True, balanced=False,
        ...
        if training:
            dataset = Imbalanced_FashionMNIST(data_dir, train=True, download=True, transform=train_trsfm, imb_factor=imb_factor)
            val_dataset = datasets.FashionMNIST(data_dir, train=False, download=True, transform=test_trsfm)  # test set
        else:
            dataset = datasets.FashionMNIST(data_dir, train=False, download=True, transform=test_trsfm)  # test set
            val_dataset = None
