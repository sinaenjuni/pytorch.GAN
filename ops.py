...
class ConditionalBatchNorm2d(nn.Module):
    ...
    def __init__(self, in_features, out_features):
        ...
        self.gain = linear(in_features=in_features, out_features=out_features, bias=False)
        self.bias = linear(in_features=in_features, out_features=out_features, bias=False)
...
class SelfAttention(nn.Module):
    ...
    def __init__(self, in_channels, is_generator):
        ...
        if is_generator:
            self.conv1x1_theta = conv2d(in_channels=in_channels, out_channels=in_channels // 8, kernel_size=1,
                                                  stride=1, padding=0, bias=False)
            self.conv1x1_phi = conv2d(in_channels=in_channels, out_channels=in_channels // 8, kernel_size=1,
                                                stride=1, padding=0, bias=False)
            self.conv1x1_g = conv2d(in_channels=in_channels, out_channels=in_channels // 2, kernel_size=1,
                                              stride=1, padding=0, bias=False)
            self.conv1x1_attn = conv2d(in_channels=in_channels // 2, out_channels=in_channels, kernel_size=1,
                                                 stride=1, padding=0, bias=False)
        else:
            self.conv1x1_theta = conv2d(in_channels=in_channels, out_channels=in_channels // 8, kernel_size=1,
                                                  stride=1, padding=0, bias=False)
